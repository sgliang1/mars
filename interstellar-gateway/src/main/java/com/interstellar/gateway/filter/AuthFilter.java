...
public class AuthFilter implements GlobalFilter, Ordered {
     ...
     * 格式：逗号分隔的精确路径，如 /interstellar-auth/login,/interstellar-auth/register
     */
     ...
     * 防止 /interstellar-auth/login/ 或 /interstellar-auth//login 等变体绕过精确匹配
     */
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // 例如：ws://localhost/interstellar-chat/ws?token=xxxxx
        if (token == null) {
