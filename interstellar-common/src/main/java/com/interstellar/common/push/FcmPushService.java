 ...
 * 通过 interstellar.push.enabled=true 启用, interstellar.push.fcm.service-account-path 指定凭据文件
 */
@Service
@ConditionalOnProperty(name = "interstellar.push.enabled", havingValue = "true")
public class FcmPushService implements PushService {
    ...
    @Value("${interstellar.push.fcm.service-account-path:}")
